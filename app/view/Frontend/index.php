  ...
  <div class="container">
    <div class="row g-4">
      ...
      <div class="col-lg-3 col-md-6">
        <div class="hp-room-item" style="background-image:url('Assets/images/room/room-b1.jpg');">
      ...
      <!-- Room 2 -->
      <div class="col-lg-3 col-md-6">
        <div class="hp-room-item" style="background-image:url('Assets/images/room/room-b2.jpg');">
          <div class="hr-text text">
            <h3>king Room</h3>
      ...
      <!-- Room 3 -->
      <div class="col-lg-3 col-md-6">
        <div class="hp-room-item" style="background-image:url('Assets/images/room/room-b3.jpg');">
          <div class="hr-text text">
            <h3>Deluxe Room</h3>
      ...
      <!-- Room 4 -->
      <div class="col-lg-3 col-md-6">
        <div class="hp-room-item" style="background-image:url('Assets/images/room/room-b4.jpg');">
          <div class="hr-text text">
            <h3>Family Room</h3>
...
<section class="py-5 blog-section"> 
  <div class="container">
    ...
    <div class="blog-wrapper">
      <!-- Blog Item 1 -->
      <div class="blog-item">
        <img src="Assets/images/room/room-b4.jpg" alt="Tremblant Trip">
      ...
      <!-- Blog Item 2 -->
      <div class="blog-item">
        <img src="Assets/images/room/room-5.jpg" alt="Camping">
      ...
      <!-- Blog Item 3 -->
      <div class="blog-item">
        <img src="Assets/images/room/room-6.jpg" alt="Copper Canyon Event">
      ...
      <div class="blog-item wide">
        <img src="Assets/images/room/room-b2.jpg" alt="Iqaluit Trip">
        <span class="blog-tag">Event</span>
        <div class="blog-content">
      ...
      <div class="blog-item tall">
        <img src="Assets/images/room/room-b3.jpg" alt="Barcelona Travel">
