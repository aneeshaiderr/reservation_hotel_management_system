  ...
  <section class="rooms-section py-5">
    <div class="container">
      <div class="rooms-wrapper">
        ...
        <!-- Room 1 -->
        <div class="room-item">
          <img src="Assets/images/room/room-b1.jpg" alt="Premium King Room">
        ...
        <!-- Room 2 -->
        <div class="room-item">
          <img src="Assets/images/room/room-b2.jpg" alt="Deluxe Room">
           <div class="he-text hr-text">
            <h3>Deluxe Room</h3>
            <h2>199$<span>/Pernight</span></h2>
            <table class="w-100 mb-3">
        ...
        <!-- Room 3 -->
        <div class="room-item">
          <img src="Assets/images/room/room-b3.jpg" alt="Luxury Room">
           <div class="he-text hr-text">
            <h3>Luxury Room</h3>
            <h2>199$<span>/Pernight</span></h2>
            <table class="w-100 mb-3">
        ...
        <!-- Room 4 -->
        <div class="room-item">
          <img src="Assets/images/room/room-b4.jpg" alt="Double Room">
          <div class="he-text hr-text">
            <h3>Double Room</h3>
            <h2>199$<span>/Pernight</span></h2>
            <table class="w-100 mb-3">
        ...
        <!-- Room 5 -->
        <div class="room-item">
          <img src="Assets/images/room/room-5.jpg" alt="Room With View">
           <div class="he-text hr-text">
        ...
        <!-- Room 6 -->
        <div class="room-item">
          <img src="Assets/images/room/room-6.jpg" alt="Small View">
           <div class="he-text hr-text">
            <h3>Small View</h3>
            <h2>199$<span>/Pernight</span></h2>
            <table class="w-100 mb-3">
