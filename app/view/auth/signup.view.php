 ...
 // Feedback3-- Need proper indentation as per PSR-12 standards
...
<div class="d-flex">
  <button type="submit" class="btn-bl btn-primary bt-primary fw-bold  w-100 text-white  pe-4">Signup</button>
        ...
        <div class="card-footer text-center bg-light py-3">
          <p class="mb-0">Already have an account? <a href="<?= BASE_URL ?>/login" class="text-primary fw-semibold">Login now</a></p>
        </div>
      </div>
    </div>
  </div>
